...
```
##  [1] "ggplot2"   "dplyr"     "gapminder" "stats"     "graphics" 
##  [6] "grDevices" "utils"     "datasets"  "methods"   "base"
```

```
##  [1] "forcats"   "ggplot2"   "dplyr"     "gapminder" "stats"    
##  [6] "graphics"  "grDevices" "utils"     "datasets"  "methods"  
## [11] "base"
```

```
##  [1] "stringr"   "purrr"     "readr"     "tidyr"     "tibble"   
##  [6] "tidyverse" "forcats"   "ggplot2"   "dplyr"     "gapminder"
...
![](cm012-exercise_files/figure-html/unnamed-chunk-1-1.png)<!-- -->
 ^ TRUE ~ means the values that are not assigned; the code also doesnt need the range since the lower limit have defined ranges.

  ^ by default, the levels are arranged alphabetically
...
^ can choose to drop or not based on the importance of the values to be dropped
...
```r
h_countries=c("Canada","Japan","Philippines","Cuba","Belgium")
h_gap<-gapminder %>% 
...
## [1] 142
```
^after filtering the data, the gapminder still has 142 countries (which is not a good use of space if you don't need the other information)
...
![](cm012-exercise_files/figure-html/unnamed-chunk-6-1.png)<!-- -->
