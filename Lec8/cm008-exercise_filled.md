...
![](cm008-exercise_filled_files/figure-html/unnamed-chunk-2-1.png)<!-- -->
<!--jitter is used to avoid the older fnc; lm is the fnc for fitting a linear fnc-->
...
```r
gapminder %>% 
  #group_by(country) %>%  (bc grouping in ggplot(inside the fnc) is different from grouping in dplyr )
  ggplot(aes(year, lifeExp,group=country,colour=country== "Rwanda")) +
  geom_line(alpha=1/3) +
  scale_colour_discrete("Rwanda",labels=c("Other","Rwanda"))
```

![](cm008-exercise_filled_files/figure-html/unnamed-chunk-3-1.png)<!-- -->

```r
#the + after each line is important
```
...
ggplot(gapminder, aes(gdpPercap, lifeExp)) +
  ...
  facet_wrap(~continent, scales="free") + # ~ indicates a formula #take out the free for better axis for easier comparison between scales
  theme_linedraw()
```

![](cm008-exercise_filled_files/figure-html/unnamed-chunk-4-1.png)<!-- -->
...
gapminder %>% 
  ...
  ggplot(aes(gdpPercap, lifeExp, size=pop, fill=continent)) + #fill is the colour inside but "colour" is the outline
...
![](cm008-exercise_filled_files/figure-html/unnamed-chunk-5-1.png)<!-- -->
...
![](cm008-exercise_filled_files/figure-html/unnamed-chunk-6-1.png)<!-- -->
...
![](cm008-exercise_filled_files/figure-html/unnamed-chunk-7-1.png)<!-- -->
...
![](cm008-exercise_filled_files/figure-html/unnamed-chunk-8-1.png)<!-- -->
...
![](cm008-exercise_filled_files/figure-html/unnamed-chunk-9-1.png)<!-- -->
...
![](cm008-exercise_filled_files/figure-html/unnamed-chunk-10-1.png)<!-- -->
...
![](cm008-exercise_filled_files/figure-html/unnamed-chunk-12-1.png)<!-- -->
...
![](cm008-exercise_filled_files/figure-html/unnamed-chunk-14-1.png)<!-- -->
