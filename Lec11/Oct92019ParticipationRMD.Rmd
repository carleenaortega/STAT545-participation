...
Note: initially did the lecture in R since that's what Firas opened and then converted to rmd so TAs can have a better access, however the commands are not working properly.
...
cannot run these examples from lecture
